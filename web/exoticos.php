...
<html lang="es">
    <head>
        ...
        <link rel="stylesheet" href="../css/styleExoticos.css">
    ...
    <div class="cont" id="blur">
            <header>
                ...
                <ul class="navigation">
                    <li><a href="perros.php" class="perros">Perros</a></li>
            ...
            <?php
                echo "<br><br><br>";
                $sentencia = $conn->prepare("SELECT * FROM animales WHERE tipo='exotico'");
                $sentencia->execute();  
